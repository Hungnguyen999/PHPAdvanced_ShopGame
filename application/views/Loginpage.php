...
<head>
    ...
    <link href="../public/css/Loginpage.css" rel="stylesheet" id="bootstrap-css">
...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <!-- Login Form -->
    <form action="/PHPmvc/index.php?url=userController/Login" method="POST">
      <input type="email" class="fadeIn second" name="username" placeholder="username" required>
